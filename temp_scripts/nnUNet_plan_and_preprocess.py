...
def main():
    ...
    parser.add_argument("-train_path", nargs="+", help="train path")
    parser.add_argument("-val_path", nargs="+", help="train path")
    parser.add_argument("-train_csv", nargs="+", help="train path")
    parser.add_argument("-val_csv",  nargs="+", help="train path")
    parser.add_argument("-task_name",  nargs="+", help="train path")
    parser.add_argument("-task_type",  nargs="+", help="task type")
    parser.add_argument("-t", "--task_ids", required=False, nargs="+", help="List of integers belonging to the task ids you wish to run"
    ...
    preprocessing_output_dir_this_task = os.path.join("configs", task_type[0], task_names[0])
    cropped_out_dir = '/media/gandalf/AE3416073415D2E7/CHAOS_pancreas_MRI_nifty/Task038_CHAOS_Task_3_5_Variant2/dump'
    ...
    for task_name in task_names:
        train_df = pd.read_csv(args.train_csv[0])
        val_df = pd.read_csv(args.train_csv[0])
    ...
    for t in tasks:
     ...
     #   cropped_out_dir = os.path.join(nnUNet_cropped_data, t)
        ...
        if planner_3d is not None:
            ...
            exp_planner.my_plan_experiment()
