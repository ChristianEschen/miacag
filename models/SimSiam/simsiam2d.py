...
from models.backbones._2D.resnet import ResNet18, ResNet34, ResNet50, ResNet101, ResNet152
...
class SimSiam(nn.Module):
    def __init__(self, in_channels, backbone, feat_dim, num_proj_layers):
        super(SimSiam, self).__init__()
        self.backbone = SimSiam.get_backbone(backbone, in_channels)
    ...
    @staticmethod
    def get_backbone(backbone_name, in_channels):
