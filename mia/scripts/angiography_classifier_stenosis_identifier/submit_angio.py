...
if __name__ == '__main__':
    ...
    config_path = "/home/gandalf/mia/configs/classification/_3D/lca_rca"
    config_path = [
...
# STAGE 2
    ...
    config_path = "/home/gandalf/mia/configs/classification/_3D/stenosis_detection_rca"
    config_path = [
        os.path.join(config_path, i) for i in os.listdir(config_path)]
    master_addr = os.environ['MASTER_ADDR']
    num_workers = args.num_workers
    ...
    for i in range(0, len(config_path)):
        ...
        if exp_exists is False:
            ...
            #output_table_name_2 = experiment_name + "_" + output_table_name
