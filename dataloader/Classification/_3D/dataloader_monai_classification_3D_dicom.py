...
class train_monai_classification_loader(base_monai_classification_loader):
    ...
    def __call__(self):
        ...
        train_transforms = [
                ...
                # RandLambdad(keys=self.features, func=RandomCropVideo(32)),
                RandSpatialCropd(keys=self.features,
                                 ...
                                 random_size=False),
               # RandTorchVisiond(keys=self.features, name='RandomCropVideo'),
...
class val_monai_classification_loader(base_monai_classification_loader):
    ...
    def __call__(self):
        val_transforms = [
                ...
                self.maybeReorder_z_dim(),
                Resized(keys=self.features,
                        spatial_size=(self.config['loaders']['Resize_depth'],
